...
/**
 * @file
 * Custom setting for Ruhi theme.
 */
function ruhi_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $image_folder = $GLOBALS['base_url'] . '/' . \Drupal::service('extension.list.theme')->getPath('ruhi') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
  $ruhipro = '<img src="' . $image_folder . 'ruhipro.jpg" />';
	$form['#attached']['library'][] = 'ruhi/theme-settings';
  $form['ruhi'] = [
    '#type'       => 'vertical_tabs',
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thank you for using Ruhi Theme</h3>Ruhi is a free Drupal 8, 9, 10, 11 theme designed and developed by <a href="https://www.drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'ruhi',
  ];
  $form['layout'] = [
    '#type'  => 'details',
  ...
  $form['upgrade'] = [
    '#type'  => 'details',
    '#title' => t('Upgrade To RuhiPro'),
    '#description'  => t('<h3>Upgrade To RuhiPro For $29 Only</h3><ul><li>One time payment.</li><li>No re-curring payment</li><li>No renewal fee.</li><li>Free life time updates.</li><li>One year support</li></ul>'),
    '#group' => 'ruhi',
  ];
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://www.drupar.com/theme/ruhi" target="_blank">Theme Homepage</a> || <a href="https://demo2.drupar.com/ruhi/" target="_blank">Theme Demo</a> || <a href="https://www.drupar.com/doc/ruhi" target="_blank">Theme Documentation</a> || <a href="https://www.drupar.com/doc/ruhi/support" target="_blank">Theme Support</a>'),
  ];
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To RuhiPro for $29 only'),
    '#description' => t('<p><a href="https://www.drupar.com/theme/ruhipro" target="_blank">Purchase RuhiPro</a> || <a href="https://demo2.drupar.com/ruhipro/" target="_blank">RuhiPro Demo</a></p>') . $ruhipro,
  ];
  /*
   * Layout
   */
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'ruhi'),
    '#description'   => t('ruhi theme has limitation of single image for slider. Separate image for each slide is available in RuhiPro. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Buy RuhiPro for $29 only.</a>'),
  ];
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code'),
    '#description'   => t('Please refer to this <a href="https://www.drupar.com/doc/ruhi/homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  /*
   * Header
   */
  ...
  $form['header']['header_links']['header_links_section'] = [
    '#type'        => 'fieldset',
    '#description'   => t('<a href="https://www.drupar.com/doc/ruhi/how-manage-website-logo" target="_blank">Change Logo</a> || <a href="https://www.drupar.com/doc/ruhi/how-change-favicon-icon" target="_blank">Change Favicon Icon</a> || <a href="https://www.drupar.com/doc/ruhi/header-main-menu" target="_blank">Manage Main Menu</a> || <a href="https://www.drupar.com/doc/ruhi/sliding-search-form" target="_blank">Sliding Search Form</a>'),
  ];
  // Header -> Sticky header.
  $form['header']['sticky_header'] = [
    '#type'        => 'details',
    '#title'       => t('Sticky Header'),
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Buy RuhiPro for $29 only.</a>'),
    '#group' => 'header_tab',
  ];
  ...
  $form['sidebar']['sidebar_block']['sidebar_block_color'] = [
    ...
    '#description'   => t('Color option is available in the premium version of this theme. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Buy RuhiPro for $29 only.</a>'),
    '#open' => TRUE,
  ];
  /*
   * Content
  ...
  $form['content']['shortcodes'] = [
    '#type'          => 'details',
    '#title'         => t('Shortcodes'),
    '#description'   => t('<p>Ruhi theme has many custom shortcodes which you can use for creating contents.</p><p>Please visit this page for list of all available shortcodes and how to use these shortcodes.</p><ul><li><a href="https://www.drupar.com/node/1485/" target="_blank">Ruhi Shortcodes</a></li><li><a href="https://www.drupar.com/node/1211/" target="_blank">The-X Shortcodes</a></li></ul><p><hr /></p><h4>More Shortcodes</h4><p><a href="https://www.drupar.com/theme/ruhipro">RuhiPro</a> has more custom shortcodes like Tab, Accordion, icon box, card, Model etc.'),
    '#group' => 'content_tab',
  ];
  // content -> RTL
  ...
  $form['content']['content_direction']['rtl'] = [
    ...
    '#disabled'   => TRUE,
    //'#description'   => t('ruhi theme is Right-to-left (RTL) languages compatible. Check this option to enable RTL. This feature is currently under testing phase. So, this may not work perfectly.'),
  ];
  ...
  $form['content']['animated_content']['animated_content_section'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Animated Page Content - RuhiPro Feature'),
    '#description'   => t('<p>With animated page content shortcodes, you can create contents with animation effects. These contents will appear with some animation effect when it will come in browser view.</p><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Buy RuhiPro for $29 only.</a></p>'),
  ];
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#description'   => t("Check this option to show website copyright text in footer. Uncheck to hide.<br />Read more: <a href='https://www.drupar.com/doc/ruhi/copyright-text-footer' target='_blank'>Copyright Text in Footer</a>"),
  ];
  ...
  $form['typography']['body']['body_line_height_section']['body_line_height'] = [
    ...
    '#description'   => t("Default value is 1.6"),
  ];
  ...
  $form['components']['fonts']['fonts_section']['font_src'] = [
    ...
    '#description'   => t('ruhi theme uses following Google fonts: Noto Sans.<br />You can serve these fonts locally or from Google server.'),
  ];
  // Components -> Social
  ...
  $form['components']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h3>Share Page On Social networking websites</h3><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Buy RuhiPro for $29 only.</a></p>'),
    '#group' => 'components_tab',
  ];
  ...
  $form['components']['font_icons']['materialicons'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Purchase RuhiPro for $29 only.</a>'),
  ];
  ...
  $form['insert_codes']['head'] = [
    '#type'        => 'details',
    '#title'       => t('Head'),
    '#description' => t('<h3>Insert Codes Before &lt;/HEAD&gt;</h3><p><hr /></p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Buy RuhiPro for $29 only.</a>'),
  ...
  $form['insert_codes']['css']['css_section']['styling'] = [
    ...
    '#description'   => t("Check this option to enable custom styling. Uncheck to disable this feature.<br />Please refer to this tutorial page. <a href='https://www.drupar.com/doc/ruhi/custom-css' target='_blank'>How To Use Custom Styling</a>"),
  ];
  ...
  $form['insert_codes']['css']['css_section']['styling_code'] = [
    ...
    '#description'   => t('Please enter your custom css codes in this text box. You can use it to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://www.drupar.com/doc/ruhi/custom-css" target="_blank">Custom CSS</a>'),
  ];
  // Settings under support tab.
  $form['support']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Documentation'),
    '#description' => t('<h4>Ruhi Documentation</h4>
    <p>Please check our documentation for detailed information on how to use ruhi theme.<br /><a href="https://www.drupar.com/doc/ruhi" target="_blank">Ruhi Documentation</a>.</p>
    <h4>The-X Documentation</h4>
    <p>Ruhi theme uses The-X theme as the base theme. So, many things are covered in <a href="https://www.drupar.com/doc/thex" target="_blank">The X Documentation</a>.</p>
    <hr />
    <h4>Create Issue</h4>
    <p>If you need support that is beyond our theme documentation, please <a href="https://www.drupal.org/project/issues/ruhi?status=All&categories=All" target="_blank">Create an issue</a> at project page.</p>
    <hr />
    <h4>Contact Us</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<p><a href="https://demo2.drupar.com/ruhipro/" target="_blank">ruhiPro Demo</a> | <a href="https://www.drupar.com/theme/ruhipro" target="_blank">Purchase ruhiPro for $29 only</a></p>'),
    '#description' => t("$ruhipro"),
  ];
// End form.
}
