...
/* themes/contrib/ruhi/templates/content/node.html.twig */
class __TwigTemplate_7fccdcd5e1a2e5effc7ebdf210e8cdcc extends Template
{
...
";
    ...
    ";
      ...
      ";
            ...
            // line 94
            yield "      ";
            yield t("<span><i class=\"icon-user user-icon primary\"></i> @author_name</span><span><i class=\"icon-calendar primary\"></i> @createdDate</span>", array("@author_name" => ($context["author_name"] ?? null), "@createdDate" => ($context["createdDate"] ?? null), ));
            // line 95
            yield "      ";
            if (($context["node_tags"] ?? null)) {
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_tags", [], "any", false, false, true, 96)) {
                    // line 97
                    yield "        <span><i class=\"icon-hashtag primary\"></i>
        ";
                    // line 98
...
";
        ...
        // line 110
        yield "  <div";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["node-content clear"], "method", false, false, true, 110), "html", null, true);
        yield ">
    ";
        // line 111
...
";
    ...
    {
        return "themes/contrib/ruhi/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/ruhi/templates/content/node.html.twig", "/Users/khagendraneupane/Development/Drupal/smartinnovation/web/themes/contrib/ruhi/templates/content/node.html.twig");
    }
